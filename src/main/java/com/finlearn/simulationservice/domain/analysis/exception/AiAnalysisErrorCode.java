...
public enum AiAnalysisErrorCode {
    ...
    INVALID_ANALYSIS_TYPE("AI_INVALID_ANALYSIS_TYPE", "analysisType", "analysisType은 null일 수 없습니다."),
    INVALID_SUMMARY("AI_INVALID_SUMMARY", "summary", "summary는 blank일 수 없습니다.");
